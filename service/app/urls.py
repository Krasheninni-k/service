...
urlpatterns = [
     path('', views.index,
          name='index'),
     # Закупки
     path('app/order_add/', views.order_add,
          name='order_add'),
     path('app/order_detail_add/', views.order_detail_add,
          name='order_detail_add'),
     path('app/orders/', views.orders_list,
          name='orders_list'),
     path('app/orders/<int:pk>/', views.order_detail,
          name='order_detail'),
     path('app/orders/<int:pk>/delete/', views.order_delete,
          name='order_delete'),
     path('app/orders/<int:pk>/edit/', views.order_edit,
          name='order_edit'),
     path('app/orders/<int:order_number>/edit/<int:pk>', views.order_detail_edit,
          name='order_detail_edit'),
     path('app/orders/<int:pk>/received/', views.order_received,
          name='order_received'),
     # Товары, Остатки
     ...
     path('app/import/catalog/', views.import_catalog_data, name='import_catalog_data'),
]
